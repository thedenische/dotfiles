...
local function java_keymaps()
    ...
    --  organize imports
    vim.keymap.set('n', '<leader>lo', jdtls.organize_imports, { desc = '[L]sp [O]rganize Imports' })
    -- Set a Vim motion to <Space> + <Shift>J + v to extract the code under the cursor to a variable
    vim.keymap.set('n', '<leader>lev', jdtls.extract_variable, { desc = '[L]sp [E]xtract [V]ariable' })
    -- Set a Vim motion to <Space> + <Shift>J + v to extract the code selected in visual mode to a variable
    vim.keymap.set('v', '<leader>lev', function() jdtls.extract_variable(true) end, { desc = '[L]sp [E]xtract [V]ariable' })
    -- Set a Vim motion to <Space> + <Shift>J + <Shift>C to extract the code under the cursor to a static variable
    vim.keymap.set('n', '<leader>lec', jdtls.extract_constant, { desc = '[L]sp [E]xtract [C]onstant' })
    -- Set a Vim motion to <Space> + <Shift>J + <Shift>C to extract the code selected in visual mode to a static variable
    vim.keymap.set('v', '<leader>lec', function() jdtls.extract_constant(true) end, { desc = '[L]sp [E]xtract [C]onstant' })
    -- Set a Vim motion to <Space> + <Shift>J + t to run the test method currently under the cursor
    vim.keymap.set('n', '<leader>ltr', jdtls.test_nearest_method, { desc = '[L]sp [T]est [R]un' })
    -- Set a Vim motion to <Space> + <Shift>J + t to run the test method that is currently selected in visual mode
    vim.keymap.set('v', '<leader>ltr', function() jdtls.test_nearest_method(true) end, { desc = '[L]sp [T]est [R]un' })
    -- Set a Vim motion to <Space> + <Shift>J + <Shift>T to run an entire test suite (class)
    vim.keymap.set('n', '<leader>ltR', jdtls.test_class, { desc = '[L]sp [T]est [R]un All' })
    -- Set a Vim motion to <Space> + <Shift>J + u to update the project configuration
    vim.keymap.set('n', '<leader>lju', '<Cmd> JdtUpdateConfig<CR>', { desc = '[L]sp [J]ava [U]pdate Config' })
end
